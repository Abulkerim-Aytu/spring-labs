...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({AddressNotFoundException.class, CustomerNotFoundException.class,
            DiscountNotFoundException.class, OrderNotFoundException.class, ProductNotFoundException.class})
